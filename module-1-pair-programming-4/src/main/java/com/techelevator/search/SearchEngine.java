...
public class SearchEngine {
	...
	public void indexFiles() throws SearchEngineException, Exception {
		...
		List<String> allFiles = sd.getFiles();
		for (String searchFilename : allFiles) {
			File currentFile = new File(searchFilename);
			Scanner currentSearch = new Scanner(currentFile);
			while (currentSearch.hasNextLine()) {
				String thisLine = currentSearch.nextLine();
				indexWords(allFiles.indexOf(searchFilename), thisLine);
			}
		}
